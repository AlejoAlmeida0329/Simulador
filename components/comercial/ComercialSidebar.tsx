 ...
 * COMERCIAL SIDEBAR
 *
 * Sidebar para panel de comercial
 * Navegación principal del comercial
 */
    ...
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-gray-900">Tikin Comercial</h2>
            <p className="text-xs text-gray-500">Mi panel</p>
          </div>
        </div>
      </div>
