...
export default async function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-8 max-w-[1800px]">
      ...
      <PageHeader
        title="Dashboard"
        description={`Bienvenido de vuelta, ${profile?.email}`}
      />
      ...
      <div className="bg-white rounded-lg shadow-soft border border-tikin-dark-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <ActionCard
            title="Gestionar Comerciales"
            description="Ver y administrar comerciales e invitaciones"
          ...
          <ActionCard
            ...
            description="Todas las cotizaciones del sistema"
